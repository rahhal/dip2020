 ...
 */
final class Version20200412162142 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exitt ADD user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE exitt ADD CONSTRAINT FK_62467E2BA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_62467E2BA76ED395 ON exitt (user_id)');
        ...
        $this->addSql('ALTER TABLE inventory CHANGE user_id user_id INT DEFAULT NULL, CHANGE inv_number inv_number VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employee CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE exitt DROP FOREIGN KEY FK_62467E2BA76ED395');
        $this->addSql('DROP INDEX IDX_62467E2BA76ED395 ON exitt');
        $this->addSql('ALTER TABLE exitt DROP user_id');
        $this->addSql('ALTER TABLE institution CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE inventory CHANGE user_id user_id INT DEFAULT NULL, CHANGE inv_number inv_number VARCHAR(255) CHARACTER SET utf8 DEFAULT \'NULL\' COLLATE `utf8_unicode_ci`');
