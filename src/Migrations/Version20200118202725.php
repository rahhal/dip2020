 ...
 */
final class Version20200118202725 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE journal CHANGE unit_cost unit_cost NUMERIC(15, 3) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE amount_allocated amount_allocated NUMERIC(15, 3) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE demand CHANGE tranche tranche VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE journal CHANGE unit_cost unit_cost INT NOT NULL');
        $this->addSql('ALTER TABLE line_demand CHANGE remarque remarque VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`');
        $this->addSql('ALTER TABLE line_exitt CHANGE article_id article_id INT DEFAULT NULL');
