 ...
 */
final class Version20200106193535 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE line_stock (id INT AUTO_INCREMENT NOT NULL, line_purchase_id INT NOT NULL, stock_id INT NOT NULL, qty_update INT NOT NULL, old_qty INT NOT NULL, quantity_alerte INT NOT NULL, valid_date DATE NOT NULL, prod_date DATE NOT NULL, reference VARCHAR(255) NOT NULL, date DATE NOT NULL, unit_price NUMERIC(15, 3) NOT NULL, INDEX IDX_B4B271E362E93E5A (line_purchase_id), INDEX IDX_B4B271E3DCD6110 (stock_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
