 ...
 */
final class Version20191222103450 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, amount_allocated NUMERIC(15, 3) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE line_purchase (id INT AUTO_INCREMENT NOT NULL, article_id INT DEFAULT NULL, purchase_id INT NOT NULL, quantity_delivred INT NOT NULL, unit_price NUMERIC(15, 3) NOT NULL, tax INT NOT NULL, quantity_required INT NOT NULL, technical_confirmity TINYINT(1) NOT NULL, remarque VARCHAR(255) NOT NULL, total_price NUMERIC(15, 3) NOT NULL, production DATE NOT NULL, validation DATE NOT NULL, INDEX IDX_B27481417294869C (article_id), INDEX IDX_B2748141558FBEB9 (purchase_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE request_supplied (id INT AUTO_INCREMENT NOT NULL, supplier_id INT NOT NULL, date DATETIME NOT NULL, tranche VARCHAR(255) NOT NULL, INDEX IDX_9ADB390A2ADD6D8C (supplier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, company VARCHAR(255) DEFAULT NULL, director VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) NOT NULL, address LONGTEXT DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, fullname VARCHAR(255) DEFAULT NULL, rib VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
