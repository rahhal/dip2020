 ...
 */
final class Version20200318094412 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demand ADD user_id INT DEFAULT NULL, CHANGE tranche tranche VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_428D7973A76ED395 ON demand');
        $this->addSql('ALTER TABLE demand DROP user_id, CHANGE tranche tranche VARCHAR(255) CHARACTER SET utf8 DEFAULT \'NULL\' COLLATE `utf8_unicode_ci`');
        $this->addSql('ALTER TABLE employee CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE institution CHANGE user_id user_id INT DEFAULT NULL');
