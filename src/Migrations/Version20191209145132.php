 ...
 */
final class Version20191209145132 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, unit VARCHAR(255) NOT NULL, reference_stock VARCHAR(255) NOT NULL, ini_qty INT NOT NULL, min_qty INT NOT NULL, created_at DATE NOT NULL, INDEX IDX_23A0E6612469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE budget (id INT AUTO_INCREMENT NOT NULL, year DATE NOT NULL, amount NUMERIC(10, 3) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, budget_id INT NOT NULL, name VARCHAR(255) NOT NULL, amount_allocated NUMERIC(15, 3) NOT NULL, INDEX IDX_64C19C136ABA6B8 (budget_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commission (id INT AUTO_INCREMENT NOT NULL, employee_id INT NOT NULL, date DATE NOT NULL, INDEX IDX_1C6501588C03F15C (employee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE employee (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, activity VARCHAR(255) NOT NULL, phone INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE exitt (id INT AUTO_INCREMENT NOT NULL, employee_id INT NOT NULL, date DATE NOT NULL, number VARCHAR(255) NOT NULL, total_price NUMERIC(15, 3) NOT NULL, INDEX IDX_62467E2B8C03F15C (employee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE institution (id INT AUTO_INCREMENT NOT NULL, ministry VARCHAR(255) NOT NULL, office VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, director VARCHAR(255) NOT NULL, economist VARCHAR(255) NOT NULL, administrator VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, phone INT NOT NULL, fax INT NOT NULL, year VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE line_exitt (id INT AUTO_INCREMENT NOT NULL, exitt_id INT NOT NULL, article_id INT DEFAULT NULL, quantity INT NOT NULL, unit_price NUMERIC(15, 3) NOT NULL, tax INT NOT NULL, total_price NUMERIC(15, 3) NOT NULL, INDEX IDX_9DC259A87C5ADC8E (exitt_id), INDEX IDX_9DC259A87294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE line_exitt_line_stock (line_exitt_id INT NOT NULL, line_stock_id INT NOT NULL, INDEX IDX_FBF2FDFAAF398CF4 (line_exitt_id), INDEX IDX_FBF2FDFADEAE316A (line_stock_id), PRIMARY KEY(line_exitt_id, line_stock_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE line_purchase (id INT AUTO_INCREMENT NOT NULL, article_id INT DEFAULT NULL, purchase_id INT NOT NULL, quantity_delivred INT NOT NULL, unit_price NUMERIC(15, 3) NOT NULL, tax INT NOT NULL, quantity_required INT NOT NULL, technical_confirmity TINYINT(1) NOT NULL, remarque VARCHAR(255) NOT NULL, production VARCHAR(255) DEFAULT NULL, validation VARCHAR(255) DEFAULT NULL, total_price NUMERIC(15, 3) NOT NULL, INDEX IDX_B27481417294869C (article_id), INDEX IDX_B2748141558FBEB9 (purchase_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE line_request_supplied (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, request_supplied_id INT NOT NULL, quantity INT NOT NULL, remarque VARCHAR(255) NOT NULL, INDEX IDX_C4AB25987294869C (article_id), INDEX IDX_C4AB25987453C69A (request_supplied_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE menu (id INT AUTO_INCREMENT NOT NULL, day VARCHAR(255) NOT NULL, breakfast VARCHAR(255) NOT NULL, lunch VARCHAR(255) NOT NULL, dinner VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nb_meal (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, std_resident INT NOT NULL, std_semi_resident INT NOT NULL, std_granted INT NOT NULL, professor INT NOT NULL, employee INT NOT NULL, curators INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE request_supplied (id INT AUTO_INCREMENT NOT NULL, supplier_id INT NOT NULL, date DATETIME NOT NULL, tranche VARCHAR(255) NOT NULL, INDEX IDX_9ADB390A2ADD6D8C (supplier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE supplier (id INT AUTO_INCREMENT NOT NULL, company VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, activity VARCHAR(255) NOT NULL, tax_number VARCHAR(255) NOT NULL, phone INT NOT NULL, address VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
