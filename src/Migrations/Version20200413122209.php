 ...
 */
final class Version20200413122209 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exitt CHANGE user_id user_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE journal ADD user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE journal DROP user_id');
