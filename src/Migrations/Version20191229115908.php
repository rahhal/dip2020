 ...
 */
final class Version20191229115908 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE inventory (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, date DATE NOT NULL, state DOUBLE PRECISION NOT NULL, qty_inv INT NOT NULL, qty_stk INT NOT NULL, INDEX IDX_B12D4A367294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
