 ...
 */
final class Version20200410113204 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE line_stock ADD user_id INT DEFAULT NULL, CHANGE valid_date valid_date DATE DEFAULT NULL, CHANGE prod_date prod_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE line_stock ADD CONSTRAINT FK_B4B271E3A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_B4B271E3A76ED395 ON line_stock (user_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE line_stock DROP FOREIGN KEY FK_B4B271E3A76ED395');
        $this->addSql('DROP INDEX IDX_B4B271E3A76ED395 ON line_stock');
        $this->addSql('ALTER TABLE line_stock DROP user_id, CHANGE valid_date valid_date DATE DEFAULT \'NULL\', CHANGE prod_date prod_date DATE DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE menu CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE nb_meal CHANGE user_id user_id INT DEFAULT NULL, CHANGE std_resident std_resident INT DEFAULT NULL, CHANGE std_semi_resident std_semi_resident INT DEFAULT NULL, CHANGE std_granted std_granted INT DEFAULT NULL, CHANGE professor professor INT DEFAULT NULL, CHANGE employee employee INT DEFAULT NULL, CHANGE curators curators INT DEFAULT NULL');
        $this->addSql('ALTER TABLE purchase CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE stock CHANGE user_id user_id INT DEFAULT NULL');
