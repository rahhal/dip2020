 ...
 */
final class Version20200107144738 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE line_request_supplied (id INT AUTO_INCREMENT NOT NULL, quantity INT NOT NULL, remarque VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE request_supplied (id INT AUTO_INCREMENT NOT NULL, date DATE DEFAULT NULL, tranche VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
