 ...
 */
final class Version20200129141741 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE line_stock_line_exitt (line_stock_id INT NOT NULL, line_exitt_id INT NOT NULL, INDEX IDX_6DFBB296AF398CF4 (line_exitt_id), INDEX IDX_6DFBB296DEAE316A (line_stock_id), PRIMARY KEY(line_stock_id, line_exitt_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
